...
main_application.title('Dutta Text Editor')
...
view.add_checkbutton(label = 'Status bar', onvalue = True, offvalue = 0, variable = show_statusbar, image = status_bar_icon,
